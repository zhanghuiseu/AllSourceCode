     ...
     */
...

     {
         ...
         //if(res)
             //cout<<"PLFF Parse Compelete Sucessfully : "<<boolalpha<<res<<endl;
         //else
             //cout<<"PLFF Parse Compelete Failed : "<<boolalpha<<res<<endl;
         ...
         //cout<<"************    End In KQuery Parser And PLFF Solver    ************"<<endl;

     ...
     */
...

     {
          ...
          //这个是采用文件读写完成的,效率太低
          //string path = "./src/one.kquery";
          //string path = "/home/zy/Desktop/KleeFloatExamples/AllResult/1.result";
          //ifstream stream;
          //stream.open(path);
         ...
         //if(res)
             //cout<<"LFF Parse Compelete Sucessfully : "<<boolalpha<<res<<endl;
         //else
             //cout<<"LFF Parse Compelete Failed : "<<boolalpha<<res<<endl;

         //cout<<endl<<"Solver Info Is Following: "<<endl;
         //trans->getSolver()->printInfo();

         //cout<<"Game Over!!!"<<endl;

         //cout<<"************    End In KQuery Parser And LFF Solver    ************"<<endl;

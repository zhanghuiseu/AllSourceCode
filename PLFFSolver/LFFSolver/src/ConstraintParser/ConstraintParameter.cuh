...
public:
	 ...
	 * */ 
	static RuntimeValue* getConstraintValue_0_0(FloatType DOUBLE_doubleA , FloatType DOUBLE_doubleB);
	static RuntimeValue* getConstraintValue_0_1(FloatType DOUBLE_doubleA , FloatType DOUBLE_doubleB);
	static RuntimeValue* getConstraintValue_0_2(FloatType DOUBLE_doubleA , FloatType DOUBLE_doubleB);
};

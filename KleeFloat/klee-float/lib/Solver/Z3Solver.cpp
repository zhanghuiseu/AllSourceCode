...
//add by zhanghui 20181029 这个函数没有调用过
bool Z3SolverImpl::computeTruth(const Query &query, bool &isValid) {
  ...
  isValid = !hasSolution;
  //isValid = 0; // modified by zhanghui 20181028  
  return status;
}
...
//add by zhanghui 20181029 只有这个函数被调用过
...
bool Z3SolverImpl::internalRunSolver(
  ...
  /*%%%%%%%%%%%%%%%%%%%  Begin add by zhanghui 20181026 %%%%%%%%%%%%%%%%%%%%%%%%*/
  string z3InputFormat = string(Z3_solver_to_string(builder->ctx, theSolver));
  /*%%%%%%%%%%%%%%%%%%%  End add by zhanghui 20181026 %%%%%%%%%%%%%%%%%%%%%%%%*/
  ...
  */
  ...
  ss<<"KQuery Constraint : \n"<<kqueryInfo<<"\n";
  ss<<"Z3 Input Constraints : \n" << z3InputFormat<< "(check-sat)\n\n";
  //ss<<"Z3VarName : "<<Z3VarName<<"\n";
  //ss<<"Z3VarType : "<<Z3VarType<<"\n";
  //ss<<"Z3VarData : "<<Z3VarData<<"\n";
  //ss<<"Z3Res : "<<true<<"\n";
  ss<<"Z3TotalTime : "<<Z3TotalTime<<"\n";
  fd<<ss.str();

  //打印相关信息
  cout<<ss.str()<<endl;
  cout<<"******************     End Z3 Solver     ******************"<<endl<<endl<<endl;
  ss.clear();
  fd.close();
  /*%%%%%%%%%%%%%%%%%%%  End add by zhanghui 20181026 %%%%%%%%%%%%%%%%%%%%%%%%*/

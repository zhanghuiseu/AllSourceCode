...
#define LFF_IS_DEFAULT_STR ""  //add by zhanghui20181025
#define PLFF_IS_DEFAULT_STR ""  //add by zhanghui20181025
#define IIP_IS_DEFAULT_STR "" //add by zhanghui20190306
...
llvm::cl::opt<CoreSolverType> CoreSolverToUse(
    ...
    llvm::cl::values(clEnumValN(STP_SOLVER, "stp", "stp" STP_IS_DEFAULT_STR),
                     ...
                     clEnumValN(LFF_SOLVER, "lff", "Newly Added LFF Solver " LFF_IS_DEFAULT_STR),
                     clEnumValN(PLFF_SOLVER, "plff", "Newly Added PLFF Solver " PLFF_IS_DEFAULT_STR),
                     clEnumValN(IIP_SOLVER, "iip", "Newly Added IIP Solver" IIP_IS_DEFAULT_STR),
